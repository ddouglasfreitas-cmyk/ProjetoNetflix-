...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let heroTrailerMutedSrc = `https://www.youtube.com/embed/${heroTrailerId}?autoplay=1&mute=1&playsinline=1&controls=0&modestbranding=1&rel=0&loop=1&playlist=${heroTrailerId}`;
    let heroTrailerAudioSrc = `https://www.youtube.com/embed/${heroTrailerId}?autoplay=1&mute=0&playsinline=1&controls=1&modestbranding=1&rel=0&loop=1&playlist=${heroTrailerId}`;
    ...
    const applyHeroByPlatform = (platformKey) => {
        ...
        heroTrailerMutedSrc = `https://www.youtube.com/embed/${heroTrailerId}?autoplay=1&mute=1&playsinline=1&controls=0&modestbranding=1&rel=0&loop=1&playlist=${heroTrailerId}`;
        heroTrailerAudioSrc = `https://www.youtube.com/embed/${heroTrailerId}?autoplay=1&mute=0&playsinline=1&controls=1&modestbranding=1&rel=0&loop=1&playlist=${heroTrailerId}`;
        ...
        if (isTouchDevice && !prefersReducedMotion) {
            playHeroTrailer({ withAudio: false, isMuted: true });
        }
    };
    ...
    if (heroPlayTrigger) {
        ...
        heroPlayTrigger.addEventListener('click', () => {
            if (!heroTrailerPinnedWithAudio) {
                ...
                const shouldStartMuted = isTouchDevice ? true : heroTrailerMuted;
                playHeroTrailer({ withAudio: !shouldStartMuted, isMuted: shouldStartMuted });
                return;
            }
